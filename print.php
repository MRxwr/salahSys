...
$data = [
    ...
    'new' => ( isset($applicationType) && strtolower($applicationType) == strtolower("new")) ? '✔' : '',
    'renew' => ( isset($applicationType) && strtolower($applicationType) == strtolower("renewal")) ? '✔' : '',
    'lost' => ( isset($applicationType) && strtolower($applicationType) == strtolower("Replacement of lost")) ? '✔' : '',
    'damage' => ( isset($applicationType) && strtolower($applicationType) == strtolower("Replace. of damage")) ? '✔' : '',
    'update' => ( isset($applicationType) && strtolower($applicationType) == strtolower("Update")) ? '✔' : '',
    'upgrade' => ( isset($applicationType) && strtolower($applicationType) == strtolower("Upgrade")) ? '✔' : '',
    'pleasureA' => ( isset($licenseType) && strtolower($licenseType) == strtolower("Pleasure (A)")) ? '✔' : '',
    'pleasureB' => ( isset($licenseType) && strtolower($licenseType) == strtolower("Pleasure (B)")) ? '✔' : '',
    'fishingA' => ( isset($licenseType) && strtolower($licenseType) == strtolower("Fishing (A)")) ? '✔' : '',
    'fishingB' => ( isset($licenseType) && strtolower($licenseType) == strtolower("Fishing (B)")) ? '✔' : '',
    'cruise' => ( isset($licenseType) && strtolower($licenseType) == strtolower("Cruise")) ? '✔' : '',
    'government' => ( isset($licenseType) && strtolower($licenseType) == strtolower("Government/Comm.")) ? '✔' : '',
